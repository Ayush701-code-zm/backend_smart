...
const envVarsSchema = Joi.object()
  .keys({
    ...
    AWS_SECRET_ACCESS_KEY: Joi.string().description('AWS access key secret'),
    S3_REGION: Joi.string().description('AWS S3 bucket region'),
...
module.exports = {
  ...
  aws: {
    ...
    access_id: envVars.AWS_ACCESS_KEY_ID,
    bucket_name: envVars.S3_BUCKET,
    bucket_region: envVars.S3_REGION,
  },
  email: {
    smtp: {
